...
const EMPTY_FORM = { title: '', description: '', date: '', location: '', teamSizeLimit: 4, rounds: 1, maxShortlisted: 0, numberOfWinners: 3, session: 'none', imageUrl: '', isPublished: false, isRegistrationOpen: true, isTeamChangeAllowed: true };
  ...
  <form onSubmit={handleSubmit} className="ae-form">
    ...
    <div className="ae-form-row">
      ...
      <div className="form-group">
        ...
        <input className="form-input" type="number" name="numberOfWinners" min="1" value={formData.numberOfWinners} onChange={handleInputChange} />
      </div>
    </div>
      ...
      <header className="ae-header glass animate-fade-in">
        ...
        {user?.role === 'admin' && (
          <div style={{ display: 'flex', gap: '8px' }}>
            ...
            >
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{marginRight: '6px'}}><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
              Users
            </button>
            <button 
              className="btn btn-secondary" 
            ...
            >
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{marginRight: '6px'}}><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
              Audit Logs
            </button>
            <button 
              className="btn btn-secondary" 
